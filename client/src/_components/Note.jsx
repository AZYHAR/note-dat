...
class Note extends React.Component {
  ...
  handleChangeSize = () => {
    this.props.dispatch(
      noteActions.resizeNote(!this.props.notes.NoteFullScreen)
    );
  };
        ...
        {id != undefined && (
          <Paper className={classes.paperContainer}>
            <div className={classes.inline}>
              ...
              >
                {' '}
                {NoteFullScreen ? <ChevronRight /> : <ChevronLeft />}{' '}
              </IconButton>
            </div>
...
const connectedNote = withStyles(styles)(
  withRouter(connect(mapStateToProps)(Note))
);
